...
- **Figma** - The design tool used as the source of the project’s layout. The [Figma file](https://github.com/Ahmed-Hany-dev) designed by [Ahmed Hany](https://github.com/Ahmed-Hany-dev)
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/ahmed-hany/next-ecommerce-shopco.git
...
Feel free to submit issues for any bugs, feature requests, or general questions related to the project. You can also reach out via [email](mailto:a7med.e.cs@gmail.com) for support.
...
- **Name**:  Ahmed Hany
- **Email**: [a7med.e.cs@gmail.com](mailto:a7med.e.cs@gmail.com)
- **GitHub**: [https://github.com/Ahmed-Hany-dev](https://github.com/Ahmed-Hany-dev)
